...
if(isset($_POST['kirim'])){
    ...
    $addtomasuk = mysqli_query($db, "insert into masuk (id_produk, qty) values ('$add_barang', '$qty')");
    $updatestokmasuk = mysqli_query($db, "update produk set stok='$tambahstok' where id_produk='$add_barang'");
      ...
      <div class="main-content container-fluid px-4 py-3">
        ...
        <div class="card p-3 bg-light border-0">
          <table class="table table-bordered border-secondary">
            ...
            <tbody>
                <?php
                    $datamasuk = mysqli_query($db, "SELECT * from masuk m, produk s where s.id_produk = m.id_produk");
                    $i = 1;
